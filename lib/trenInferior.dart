...
class TrenInferiorPage extends StatefulWidget {
  @override
  _TrenInferiorPageState createState() => _TrenInferiorPageState();
}

class _TrenInferiorPageState extends State<TrenInferiorPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tren Inferior', style: TextStyle(color: Colors.white)),
